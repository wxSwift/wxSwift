...
TClass(wxPreviewFrame) wxPreviewFrame_Create( TClass(wxPrintPreview) preview, TClass(wxFrame) parent, TClass(wxString) title, TRect(x,y,width,height), int _stl, TClass(wxString) name  );
