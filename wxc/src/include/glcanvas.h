...
TClass(wxGLCanvas)   wxGLCanvas_Create( TClass(wxWindow) parent, int windowID, int* attributes, TRect(x,y,w,h), int _stl, TClass(wxString) title, TClass(wxPalette) palette );
