...
$SWIFT_BIN/swiftc -emit-module wx.swift -module-name wx -module-link-name wx -O -parse-as-library

echo "Generating wxcore.swiftmodule"
$SWIFT_BIN/swiftc -emit-module wxcore.swift -module-name wxcore -module-link-name wx -O -parse-as-library

echo "Compiling wx.swift"
$SWIFT_BIN/swiftc -c  wx.swift -O -parse-as-library

echo "Compiling wxcore.swift"
$SWIFT_BIN/swiftc -c  wxcore.swift -O -parse-as-library

echo "Compiling wxcore_cpp.cpp"
$CCC -c wxcore_cpp.cpp

echo "Building libwx.dll"
$CCC -shared -o libwx.dll wx.o wxcore.o wxcore_cpp.o -L$SWIFT_BIN/../lib/swift/mingw -lswiftCore -L C:/Work/wxSwift/wxc/build/cpp -lwxC -Wl,--out-implib,libwx.dll.a  -L $WXWIDGETS_LIBDIR -lwxbase30u -lwxbase30u_net -lwxbase30u_xml -lwxexpat -lwxjpeg -lwxmsw30u_adv -lwxmsw30u_aui -lwxmsw30u_core -lwxmsw30u_gl -lwxmsw30u_html -lwxmsw30u_media -lwxmsw30u_propgrid -lwxmsw30u_ribbon -lwxmsw30u_richtext -lwxmsw30u_stc -lwxmsw30u_webview -lwxmsw30u_xrc -lwxpng -lwxregexu -lwxscintilla -lwxtiff -lwxzlib -Xlinker --allow-multiple-definition

echo "Installing"
mv wx.swiftmodule wx.swiftdoc $SWIFT_BIN/../lib/swift/mingw/x86_64
mv wxcore.swiftmodule wxcore.swiftdoc $SWIFT_BIN/../lib/swift/mingw/x86_64
mv libwx.dll $SWIFT_BIN/../lib/swift/mingw
rm libwx.dll.a

echo 
echo "RUN swift test_wxcore1.swift"
echo " or swift test_wx1.swift"
